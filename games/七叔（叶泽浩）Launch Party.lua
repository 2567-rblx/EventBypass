...
client.Character.HumanoidRootPart.CFrame = workspace.ObstacleCourse.ObstacleEnd.Part.CFrame
task.wait(0.5)
...
while true do
	...
	firetouch(client.Character.HumanoidRootPart, workspace.ObstacleCourse.ObstacleEntries.Part)
	firetouch(client.Character.HumanoidRootPart, workspace.ObstacleCourse.ObstacleEnd.Part)
	task.wait(0.05)
end
